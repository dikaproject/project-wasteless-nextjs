...
const AnalyticsPage = () => {
  ...
  const calculateSummaryStats = (data: AnalyticsData) => {
    ...
    const totalOrders = data.dailyRevenue.reduce(
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          {
            title: "Total Orders",
            value: summaryStats?.totalOrders.toLocaleString() || "0",
            trendUp: true,
          },
          {
            title: "Average Order Value",
            value: formatCurrency(summaryStats?.averageOrderValue || 0),
            trendUp: false,
          },
        ].map((stat, index) => (
          ...
          <table className="w-full">
            <thead>
              <tr className="text-left border-b border-gray-200">
                ...
                <th className="pb-4 font-medium text-gray-600">
                  Conversion Rate
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {data?.topProducts.map((product) => (
                ...
                >
                  ...
                  <td className="py-4 text-gray-600">
                    {((product.units_sold / product.total_sold) * 100).toFixed(
                      1
                    )}
                    %
                  </td>
