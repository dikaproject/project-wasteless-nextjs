...
export default function SellerRegisterPage() {
  return (
    <>
    <Navbar />
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 pt-20 sm:pt-28">
  <div className="max-w-6xl mx-auto px-4 py-8 sm:py-16">
    <div className="text-center mb-8 sm:mb-12">
      <Store className="w-10 h-10 sm:w-12 sm:h-12 text-green-600 mx-auto mb-4" />
