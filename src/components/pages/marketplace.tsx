      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
        ...
        >
          <div className="relative h-64">
            ...
            <button
              onClick={onClose}
              className="absolute text-gray-700 top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full p-2 shadow-lg"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="p-4 space-y-3 max-h-[60vh] overflow-y-auto">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                <span className="text-xl font-bold text-green-600">
                  {formatPrice(isDiscountActive(product) ? 
                    Number(product.discount_price) || Number(product.price) : 
                    Number(product.price)
                  )}
                </span>
                {isDiscountActive(product) && product.is_discount && (
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{product.quantity} items</p>
              </div>
              <div>
                <span className="text-gray-500">Weight</span>
                <p className="font-medium text-gray-900">{product.massa} grams</p>
              </div>
              <div>
            ...
            {product.is_discount && product.discount_percentage && product.discount_percentage > 0 && (
              <div className="bg-red-50 p-3 rounded-lg text-sm">
                ...
                {isDiscountActive(product) && (
                  <p className="text-gray-600 text-xs mt-1">
                    Valid until: {format(new Date(product.end_date!), "dd MMM yyyy")}
                  </p>
                )}
              </div>
            )}
            ...
            <div className="border-t pt-3">
              ...
              <p className="text-sm text-gray-900 mt-1">{product.address}</p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Temukan Produk Dengan Harga Yang Terjangkau
              </p>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-yellow-800">
                      Peringatan Produk Expired
                    </h3>
                    <p className="mt-1 text-sm text-yellow-700">
                      Jika anda ingin membeli produk expired harap tidak menjual
                      kembali sesuai dengan UU No. 18 Tahun 2012 tentang Pangan
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <div className="space-y-8">
              ...
              <div>
                <h3 className="font-semibold mb-4 text-gray-800">Lokasi</h3>
