...
export default function RegisterFormSeller() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success("Pendaftaran berhasil! Tim kami akan meninjau aplikasi Anda.");
        router.push("/login");
      } else {
          ...
          <option key={district.id} value={district.id}>
            {district.name}
              ...
              <div>
                ...
                <div
                  ...
                  className="cursor-pointer border-2 border-dashed border-gray-300 rounded-xl p-4 hover:border-green-500 transition-colors"
                >
                  <input
                    type="file"
                    name="photo_ktp"
            ...
            <div className="flex justify-between">
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="text-gray-600 px-6 py-3 rounded-xl hover:bg-gray-50 flex items-center gap-2"
              >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="bg-green-600 text-white px-6 py-3 rounded-xl hover:bg-green-700 flex items-center gap-2 disabled:bg-gray-400"
              >
                {loading ? (
                  <>
